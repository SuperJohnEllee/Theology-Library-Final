...
<?php
	...
	$req_sql = "SELECT book_requestID FROM book_request WHERE Status = 'Rejected'";
...
<body class="cyan lighten-4">
	...
	<div class="table-scrol">
		<h1 class="text-center"><i class="fa fa-book"></i> RejectedRequested Books(<?php echo htmlspecialchars($res_count); ?>)</h1>
		<div class="container">
			<div class="page-header">
				<h3>List of Rejected Requested Books
