...
<?php
	...
	$req_sql = "SELECT book_reservationID FROM reservation WHERE Status = 'Rejected'";
...
<body class="cyan lighten-4">
	...
	<div class="table-scrol">
		<h1 class="text-center"><i class="fa fa-book"></i> Rejected Reserved Books(<?php echo htmlspecialchars($res_count); ?>)</h1>
		<div class="container">
			<div class="page-header">
				<h3>List of Rejected Reserved Books
				...
				<form class="form-horizontal" method="post">
					<div class="form-group col-lg-9">
						<div class="input-group">
							<input class="form-control" type="text" name="reserved_search" onkeyup="filterSearch()" id="request_search">
