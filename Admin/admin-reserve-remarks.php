...
<body class="cyan lighten-5">
	...
	<div class="container">
		...
		<h4>State the Remarks for rejecting a book for <span class="text-danger"><?php echo $row['BookName']; ?></span> reserved by <span class="text-warning"><?php echo $name; ?></span></h4>
		<div class="row">
